...
export default function ScheduleHUD({ activeDay, onSelectDay }: ScheduleHUDProps) {
  return (
    <div className="w-full max-w-4xl text-center pointer-events-auto select-none px-2 sm:px-4 pt-14 sm:pt-16 pb-0 z-20">
      ...
      <div className="inline-flex items-center p-0.5 sm:p-1 rounded-full bg-[#040814]/90 border border-white/15 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.85)] max-w-full overflow-x-auto sm:overflow-visible no-scrollbar [scrollbar-width:none] [&::-webkit-scrollbar]:hidden gap-0.5 sm:gap-1">
        {scheduleData.map((d) => {
          ...
          return (
            <button
              ...
              className={`relative px-2.5 sm:px-3.5 py-1 sm:py-1.5 rounded-full text-[10px] sm:text-xs font-mono font-bold tracking-wider uppercase whitespace-nowrap transition-all duration-300 ${
                isActive

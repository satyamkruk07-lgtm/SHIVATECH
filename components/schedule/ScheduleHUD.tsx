...
export default function ScheduleHUD({ activeDay, onSelectDay }: ScheduleHUDProps) {
  return (
    <div className="w-full max-w-xl text-center pointer-events-auto select-none px-4 pt-16 sm:pt-20 pb-2 z-20">
      ...
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white uppercase font-mono drop-shadow-[0_0_20px_rgba(255,255,255,0.4)] leading-none mb-1">
        SCHEDULE
      </h1>
      ...
      <div className="inline-flex items-center p-1 rounded-full bg-[#040814]/85 border border-white/15 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.8)]">
        <button
